...
export function FallbackIcon({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
...
export function IconWhatsapp({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function IconInstagram({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function IconFacebook({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function IconCheckCircle({ className = "w-2.5 h-2.5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
...
// Registry map ensures safe lookup without undefined variables
...
export function DynamicIcon({ name, className }: { name: string; className?: string }) {
  const Component = ICON_REGISTRY[name.toLowerCase()] || FallbackIcon;
