...
const professionalLinks = [
  { name: "LinkedIn", href: siteConfig.social.linkedin, detail: "Professional profile", iconKey: "linkedin" },
  { name: "GitHub", href: siteConfig.social.github, detail: "Code & repositories", iconKey: "github" },
  { name: "X", href: siteConfig.social.x, detail: "Updates & writing", iconKey: "x" },
  { name: "WhatsApp", href: siteConfig.social.whatsapp, detail: "Direct message", iconKey: "whatsapp" },
  { name: "Instagram", href: siteConfig.social.instagram, detail: "Personal profile", iconKey: "instagram" },
  { name: "Facebook", href: siteConfig.social.facebook, detail: "Personal profile", iconKey: "facebook" },
];
                  ...
                  {professionalLinks.map((link) => (
                    ...
                    >
                      <span className="flex items-center gap-2 font-medium">
                        <DynamicIcon name={link.iconKey} className="h-3.5 w-3.5 text-emerald-400" />
                        {link.name}
                      </span>
